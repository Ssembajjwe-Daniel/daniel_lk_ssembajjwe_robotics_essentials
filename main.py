...
from CuteBot import ultrasonic
...
cuteBot.move_time(cuteBot.Direction.FORWARD, 60, 300)
...
cuteBot.move_time(cuteBot.Direction.FORWARD, 60, 3000)
while True:
    distance = cuteBot.ultrasonic(cuteBot.SonarUnit.CENTIMETERS)
    
    if distance < 10:
        cuteBot.stopcar()
        basic.show_string("Turning")
    else:
